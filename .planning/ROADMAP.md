...
- [x] 09-01-PLAN.md — Write install/adopt section (aligned with `arch/*.sh` style) — DOC-01

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 09-02-PLAN.md — Write update/pin-bump + non-goals (exp-merge, cutover, customs) — DOC-02
