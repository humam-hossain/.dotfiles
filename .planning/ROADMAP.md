...
**Plans:** 3 plans
Plans:
- [ ] 13-01-PLAN.md — Service singletons: AudioService, MprisService, HyprWorkspaces (WS-01 data, AUDIO-01 data, AUDIO-03 data)
...
| 13. Native API Widgets | v1.2 | 0/3 | Not started | — |
