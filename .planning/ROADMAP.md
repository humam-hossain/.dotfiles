...
Plans:
- [ ] 10-01-PLAN.md — Align validator commands with v1.1 bug-fix scope and artifact needs
- [ ] 10-02-PLAN.md — Add scripted regression checks for uncovered keymap/plugin/crash paths
- [ ] 10-03-PLAN.md — Document validation triage so maintainers can separate config bugs from env gaps
