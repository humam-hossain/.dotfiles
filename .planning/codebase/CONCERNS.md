...
- **Issue:** An AccuWeather API key `s4pMSAgGyyOUFrF5jAzulZw8bCQGGbJz` is hardcoded in comments within the waybar config. This API key is exposed in the public dotfiles repository. Additionally, a curl URL containing the key in query parameters is visible.
