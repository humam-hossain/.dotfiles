...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 27-01-01 | 01 | 0 | INTG-01 | T-27-01 | Guard-paths contract & fail-closed harness scaffold | contract | `bash scripts/phase27-accent-coordination-assert.sh --help` | ❌ W0 | ⬜ pending |
| 27-01-02 | 01 | 1 | INTG-01 | T-27-01 | Template & config readiness (Matugen, colors.lua, custom purity) | unit | `bash scripts/phase27-accent-coordination-assert.sh --section 1` | ❌ W0 | ⬜ pending |
| 27-02-01 | 02 | 2 | SHELL-01 | T-27-02 | Hyprland border token match & live compositor query | integration | `bash scripts/phase27-accent-coordination-assert.sh --section 2` | ❌ W0 | ⬜ pending |
| 27-02-02 | 02 | 2 | SHELL-02 | T-27-02 | Quickshell M3 token schema & warning threshold integrity | integration | `bash scripts/phase27-accent-coordination-assert.sh --section 3` | ❌ W0 | ⬜ pending |
| 27-03-01 | 03 | 3 | SHELL-03 | T-27-03 | Coordinated live reload drill & border sync | integration | `bash scripts/phase27-accent-coordination-assert.sh --section 4` | ❌ W0 | ⬜ pending |
| 27-03-02 | 03 | 3 | INTG-02 | T-27-03 | Full 5-section suite pass & strict verification 0 findings | smoke / regression | `bash scripts/phase27-accent-coordination-assert.sh && ./arch/dots-hyprland.sh verify --strict` | ❌ W0 | ⬜ pending |
