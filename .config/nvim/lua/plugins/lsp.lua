	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("<leader>cr", require("fzf-lua").lsp_references, "Goto [C]ode [R]eferences")

				-- Jump to the implementation of the word under your cursor.
				--  Useful when your language has ways of declaring types without an actual implementation.
				map("<leader>ci", require("fzf-lua").lsp_implementations, "Goto [C]ode [I]mplementation")

				-- Jump to the definition of the word under your cursor.
				--  This is where a variable was first declared, or where a function is defined, etc.
				--  To jump back, press <C-t>.
				map("<leader>cd", require("fzf-lua").lsp_definitions, "Goto [C]ode [D]efinition")
				...
				map("<leader>cD", vim.lsp.buf.declaration, "Goto [C]ode [D]eclaration")
