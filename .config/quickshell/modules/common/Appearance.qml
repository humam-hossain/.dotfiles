...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3primaryDim: "#cbc4cb"
        ...
        property color m3primaryPaletteKeyColor: "#615d63"
        property color m3secondary: "#cac5c8"
        property color m3secondaryDim: "#cac5c8"
        ...
        property color m3secondaryPaletteKeyColor: "#484648"
        property color m3tertiary: "#d1c3c6"
        property color m3tertiaryDim: "#d1c3c6"
        property color m3onTertiary: "#372e30"
        property color m3tertiaryContainer: "#31292b"
        property color m3onTertiaryContainer: "#c1b4b7"
        property color m3tertiaryPaletteKeyColor: "#4e4447"
        property color m3error: "#ffb4ab"
        property color m3errorDim: "#ffb4ab"
        property color m3onError: "#690005"
        property color m3errorContainer: "#93000a"
        property color m3onErrorContainer: "#ffdad6"
        property color m3errorPaletteKeyColor: "#93000a"
        property color m3neutralPaletteKeyColor: "#797676"
        property color m3neutralVariantPaletteKeyColor: "#948f94"
